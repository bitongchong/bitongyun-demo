...
public class FileTypeJudgeUtil {
    ...
    static {
        ...
        mFileTypes.put("0000001C", "mp41");
        mFileTypes.put("00000018", "mp42");
...
//		System.out.println(builder.toString());
    ...
    public static void main(String[] args) throws Exception {
        final String fileType = getFileType("C:\\Users\\HP\\Desktop\\3~1.mp4");
        System.out.println(fileType);
        System.out.println(getFileHeader("C:\\Users\\HP\\Desktop\\3~1.mp4"));
    }
}